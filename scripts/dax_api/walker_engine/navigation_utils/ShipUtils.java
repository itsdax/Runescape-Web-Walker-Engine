...
public class ShipUtils
{
	...
	{
		final RSObject gangplank = getGangplank();
		if (gangplank == null)
		{
			return false;
		}
	...
	{
		return InteractionHelper.getRSObject(Filters.Objects.nameEquals("Gangplank").and(Filters.Objects.actionsContains("Cross")));
	}
